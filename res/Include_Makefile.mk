...
BSC_LINK_FLAGS_FASTEST = -Xc "lm" -Xl "-fuse-ld=lld"
...
BSC_LINK_FLAGS_FAST = -keep-fires -Xc "lm" -Xl "-fuse-ld=lld"
...
.PHONY: lightning
lightning: BSC_COMP_FLAGS = $(BSC_COMP_FLAGS_FASTEST)
lightning: BSC_LINK_FLAGS = $(BSC_LINK_FLAGS_FASTEST)
